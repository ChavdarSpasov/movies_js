...
export async function details() {
    ...
    const contex = Object.assign( {movie, origin: encodeURIComponent('#/details/' + movieId)}, this.app.userData);

    this.partial('./templates/movie/details.hbs', contex);
}
...
export async function edit() {
    ...
    this.partial('./templates/movie/editMovie.hbs', context);
}
